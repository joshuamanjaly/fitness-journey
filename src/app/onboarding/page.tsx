...
import { ChevronRight, Activity, Dumbbell, Zap } from "lucide-react";
...
export default function Onboarding() {
  ...
  const [formData, setFormData] = useState({
    ...
    weight: "",
    goal: "",
    bodyType: "Mesomorph", // Default value to prevent errors
  });
            ...
            {step === 3 && (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-slate-400">Creating your <span className="text-blue-400 font-bold">{formData.goal}</span> protocol.</p>
                </div>
